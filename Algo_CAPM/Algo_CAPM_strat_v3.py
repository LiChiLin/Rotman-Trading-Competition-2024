...
def adjust_positions_for_limits(
    ...
    if potential_gross_position > gross_limit or potential_net_position > net_limit:
        ...
        scale_factor_gross = min(1, (gross_limit - current_gross_position) / (potential_gross_position - current_gross_position))
        scale_factor_net = min(1, (net_limit - current_net_position) / (potential_net_position - current_net_position))
